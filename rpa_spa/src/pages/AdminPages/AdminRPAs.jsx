...
import { deleteRPAAdmin, editRPAAdmin, getRPAsAdmin } from '../../api/adminApi';
...
export default function AdminRPAs() {
    ...
    const fetchData = useCallback(async () => {
        ...
        const reqBody = {sortBy:userSortBy,
                         ...
                         query:searchQuery};
        try {
            const response = await getRPAsAdmin(reqBody);
    ...
    const handleDeleteConfirm = async () => {
        try {
            await deleteRPAAdmin(deletingItem);
            handleCloseDelete();
            fetchData();
        } catch (err) {
    ...
    const handleEditSubmit = async (requestBody, itemId) => {
        try {
            ...
            await editRPAAdmin(requestBody, parametros);
            handleCloseDialog();
            fetchData();
        } catch (err) {
            setError(<FormattedMessage id="editError"
