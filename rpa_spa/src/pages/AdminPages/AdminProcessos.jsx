...
import { deleteProcessoAdmin, editProcessoAdmin, getProcessosAdmin } from '../../api/adminApi';
...
export default function AdminProcessos() {
    ...
    const fetchData = useCallback(async () => {
        ...
        const reqBody = {sortBy:userSortBy,
                         ...
                         query:searchQuery};
        try {
            const response = await getProcessosAdmin(reqBody);
    ...
    const handleDeleteConfirm = async () => {
        try {
            await deleteProcessoAdmin(deletingItem);
            handleCloseDelete();
            fetchData();
        } catch (err) {
    ...
    const handleEditSubmit = async (requestBody, itemId) => {
        try {
            ...
            await editProcessoAdmin(requestBody, parametros);
            handleCloseDialog();
            fetchData();
        } catch (err) {
            setError(<FormattedMessage id="editError"
